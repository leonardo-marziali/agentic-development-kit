...
{
  "no-inline-html": {
    "allowed_elements": ["strong", "em", "br", "sub", "sup", "kbd", "details", "summary"]
  }
}
```
...
{
  "required-headings": {
    "headings": ["# Title", "## Description", "## Examples", "## Resources"]
  }
}
```
...
{
  "proper-names": {
    "names": ["JavaScript", "TypeScript", "GitHub", "markdownlint", "npm"],
    "code_blocks": false
  }
}
```
...
```json
{
  ...
  "required-headings": {
    "headings": ["# Title", "## Description", "## Usage", "## API"]
  }
}
```
...
```json
{
  ...
  "line-length": false,
  "no-inline-html": {
    "allowed_elements": ["img", "a", "strong", "em", "br", "div", "span"]
  },
...
```json
{
  ...
  "no-inline-html": {
    "allowed_elements": ["details", "summary", "kbd", "sub", "sup", "br"]
  },
  "code-block-style": {
    "style": "fenced"
  },
...
```json
{
  ...
  "no-inline-html": {
    "allowed_elements": ["img", "br", "details", "summary", "sup"]
  },
  "required-headings": {
    "headings": ["# *", "## Installation", "## Usage", "## License"]
  },
  "first-line-heading": {
    "level": 1
  }
